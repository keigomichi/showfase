...
const TypeChecker previewChecker =
    TypeChecker.typeNamedLiterally('Preview', inPackage: 'flutter');

/// Matches Flutter's `MultiPreview` annotation and its subclasses.
const TypeChecker multiPreviewChecker =
    TypeChecker.typeNamedLiterally('MultiPreview', inPackage: 'flutter');

/// Matches `Widget` from Flutter's widgets library.
const TypeChecker widgetChecker =
    TypeChecker.typeNamedLiterally('Widget', inPackage: 'flutter');
